...
public final class ActivityLockBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvLockout;

  private ActivityLockBinding(@NonNull LinearLayout rootView, @NonNull Button btn0,
      ...
      @NonNull Button btn9, @NonNull Button btnBackspace, @NonNull Button btnFingerprint,
      @NonNull View dot1, @NonNull View dot2, @NonNull View dot3, @NonNull View dot4,
      @NonNull View dot5, @NonNull View dot6, @NonNull LinearLayout dotsContainer,
      @NonNull TextView tvLockIcon, @NonNull TextView tvLockSubtitle, @NonNull TextView tvLockTitle,
      @NonNull TextView tvLockout) {
  ...
  public static ActivityLockBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button btnFingerprint = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.tvLockIcon;
      TextView tvLockIcon = ViewBindings.findChildViewById(rootView, id);
      if (tvLockIcon == null) {
        break missingId;
      }

      id = R.id.tvLockSubtitle;
      ...
      id = R.id.tvLockout;
      TextView tvLockout = ViewBindings.findChildViewById(rootView, id);
      if (tvLockout == null) {
        break missingId;
      }

      return new ActivityLockBinding((LinearLayout) rootView, btn0, btn1, btn2, btn3, btn4, btn5,
          btn6, btn7, btn8, btn9, btnBackspace, btnFingerprint, dot1, dot2, dot3, dot4, dot5, dot6,
          dotsContainer, tvLockIcon, tvLockSubtitle, tvLockTitle, tvLockout);
    }
